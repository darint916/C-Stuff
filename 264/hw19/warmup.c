...
uint8_t toggle_left_bits(uint8_t byte, uint8_t num_bits_to_toggle) {
	...
	return (~byte & ~(0xff >> num_bits_to_toggle)) | (byte & 0xff >> num_bits_to_toggle);  // TODO: replace this with a one-line implementation of this function.
}
